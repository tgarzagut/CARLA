...
class KeyboardControl(object):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.JOYAXISMOTION:
                if event.axis == 0:
                    ...
                    throttle_increment = 0.05 * clock.get_time()
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    world.camera_manager.next_sensor()
                elif (event.type == pygame.JOYAXISMOTION and event.axis == 1 and event.value < 1.0) and (pygame.key.get_mods() & KMOD_CTRL):
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        for event in pygame.event.get():
            if keys[K_UP] or (event.type == pygame.JOYAXISMOTION and event.axis == 1):
                if event.value < 1.0:  # Check if the pedal is pressed (value > 0)
